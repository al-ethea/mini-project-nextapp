    ...
    <div className="bg-black text-white w-full px-4">
      ...
      {pagedEvents.map((event, idx) => {
        ...
        return (
          <div key={event.id}>
            {showMonth && (
              <h2 className="text-2xl font-bold mt-10 mb-4">{event.group}</h2>
            )}
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 bg-neutral-800 rounded-lg p-4 mb-4">
              <div className="flex flex-row sm:flex-col items-center sm:justify-center w-full sm:w-16 gap-2 sm:gap-0">
              ...
              <Image
                ...
                width={100}
                height={60}
                className="object-cover rounded w-full sm:w-[100px] h-[70px]"
              />
              ...
              <div className="sm:text-right text-left">
                {event.soldOut ? (
                  ...
                  <button className="bg-red-600 hover:bg-red-700 transition text-white text-sm font-semibold px-4 py-2 rounded w-full sm:w-auto mt-2 sm:mt-0">
                    Find Tickets
                  </button>
                )}
              </div>
